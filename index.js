...
const selectedFlavor = userPreference === 'sugar-free' ? 'sugar-free' : 'Regular' ;
console.log(`User Prefers: ${selectedFlavor} variety.`);
...
const workOutIntesity = heartRate < 100 ? "boost needed" : "Energy levels high";
...
const temperatureSuitability = currentTemp < 5 ? "Chilled to perfection!" : "Needs a cooler!";
...
const whatToDrink = currentHour >= 7 && currentHour <= 23 ? "Unleashthe beast!" : "Better stick to water";
